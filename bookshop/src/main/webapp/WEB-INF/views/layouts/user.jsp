			...
			<div class="container">
				<div class="alignR">
					...
					<c:if test="${not empty LoginInfo }">
						...
						<a href="<c:url value="/dang-xuat"/>"><span class="icon-edit"></span> Đăng Xuất
						</a> 
					</c:if>
					<c:if test="${ empty LoginInfo }">
						<a href="<c:url value="/dang-ky"/>"><span class="icon-user"></span> Đăng ký</a>
					</c:if> 
					<c:if test="${ empty LoginInfo }">
				 	 ...
				 	 <a href="<c:url value="/cart"/>"><span
						...
						<span class="badge badge-warning"><fmt:formatNumber type="number" 
						groupingUsed="true" value="${ TotalPriceCart }"/>đ</span></a>
				</div>
			</div>
		</div>
	</div>
